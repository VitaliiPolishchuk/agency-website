...
const Header = () => {
  ...
  return (
    <Container id="home" ref={ref}>
      ...
      <Nav>
        <a onClick={(e) => handleClick("hero", e)}>Home</a>
        <a onClick={(e) => handleClick("about", e)}>About Us</a>
        <a onClick={(e) => handleClick("service-title", e)}>Services</a>
        <a onClick={(e) => handleClick("contact", e)}>
