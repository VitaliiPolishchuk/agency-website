...
const Services = () => {
  ...
  return (
    <Container id="services">
      ...
      <Content ref={addToRef} id="service-title">
        <TextBlock
          topic="Design"
          title="We build award winnig Designs"
          subText="We help clients to build great design to attract more customers"
        />
        <OBJ>
          <img src={Tube} alt="Tube" width="400" heihgt="400" />
        </OBJ>
      ...
      <Content>
        <TextBlock
          topic="Support"
          title="We provide support fro your digital presence"
        ...
        />
        <OBJ>
          <img src={Capsule} alt="Capsule" width="400" heihgt="400" />
        </OBJ>
